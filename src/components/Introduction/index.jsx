...
const Introduction = () => {
  return (
    <div id="intro" className="text-slate-300 w-full flex justify-center">
        ...
        <div className="w-full py-8 flex lg:flex-row flex-col gap-12">
          <div className="lg:w-[70%] w-full">
            ...
            <p className="font-Montserrat reveal transition-all sm:whitespace-nowrap font-semibold text-xl mt-6">
              A Professional{" "}
              <span className="text-rose-500"> React Developer.</span>
            </p>
            <p className="mt-6 max-w-[600px] text-sm sm:text-[16px] leading-6 font-Montserrat">
              I love creating amazing, high quality, websites and web
              applications using the most optimized web development tools in
              order to provide optimized solutions to client requirements.
            </p>
          ...
          <div className="lg:w-[30%] flex h-[300px] overflow-hidden items-start">
            <div className="w-[300px] border-r-4 border-t-4 hover:border-none transition-all duration-500 px-4 border-rose-500 h-full rounded-[10%] shadow-2xl  overflow-hidden">
              <img
                src={SpinkOne}
