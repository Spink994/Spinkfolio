  ...
  return (
    <nav className="w-full bg-[#16161d] min-h-[80px] z-50">
      <div className="fixed w-full px-8 max-w-[1440px] h-full max-h-[80px] lg:border-b-[0.5px] lg:border-slate-600 flex justify-between items-center left-[50%] bg-[#16161d] -translate-x-[50%]">
        <HashLink smooth to="#intro" className="z-20 ">
        ...
        <div
          className={`lg:flex-row lg:relative lg:gap-8  transition-all lg:h-max lg:pt-0 lg:w-max text-slate-300 flex flex-col gap-12 absolute w-full top-0 px-8 pt-[120px] bg-[#16161d] ${
            isHidden ? "lg:-translate-x-[0vw] -translate-x-[100vw]" : ""
